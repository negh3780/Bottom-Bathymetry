...
Our goal will be to
\begin{itemize}
\item[(i)]  Lay down a physically sound, methodically precise rational for the specification of the elements defining 
\eqref{eq:bayes:bath}.
\item[(ii)] Systematically resolve \eqref{eq:bayes:bath} to obtain not just point estimates of $b$ but a complete
